...
impl<B: BlockT + Unpin> Metadata<B> where B::Hash: Unpin, {
    pub async fn new(addr: Address<ActorPool<super::DatabaseActor<B>>>, extrinsics: Address<super::ExtrinsicsActor<B>>, meta: Meta<B>) -> Result<Self> {
